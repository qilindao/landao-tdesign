...
const iconsPath = import.meta.glob(
  "../../../node_modules/tdesign-icons-vue-next/esm/components/*.js"
);
...
async function getMenuIcon(iconName) {
  const RenderIcon =
    iconsPath[
      `../../../node_modules/tdesign-icons-vue-next/esm/components/${iconName}.js`
    ];
...
function asyncImportRoute(routes) {
  dynamicViewsModules =
    dynamicViewsModules || import.meta.glob("../../pages/**/*.vue");
  if (!routes) return;
